...
program
  .name('create-redesign-ai')
  .description('Create a new RedesignAI project with your choice of sandbox provider')
  .version('1.0.0')
...
async function main() {
  console.log(chalk.cyan('\n🚀 Welcome to RedesignAI Setup!\n'));

  let config = {
    sandbox: options.sandbox,
    name: options.name || 'my-redesign-ai',
